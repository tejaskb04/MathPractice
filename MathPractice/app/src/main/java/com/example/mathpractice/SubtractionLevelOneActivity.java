...
public class SubtractionLevelOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_level_one);
        ...
        CountDownTimer countDownTimer = new CountDownTimer(120000, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(SubtractionLevelOneActivity.this, "Time is Up!", Toast.LENGTH_LONG)
                        .show();
                time.setText("Time!");
