...
public class DivisionLevelFourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_division_level_four);
        ...
        countDownTimer = new CountDownTimer(120000, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(DivisionLevelFourActivity.this, "Time is Up!", Toast.LENGTH_LONG)
                        .show();
                time.setText("Time!");
