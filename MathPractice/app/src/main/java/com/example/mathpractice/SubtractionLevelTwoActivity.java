...
public class SubtractionLevelTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_level_two);
        ...
        CountDownTimer countDownTimer = new CountDownTimer(120000, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(SubtractionLevelTwoActivity.this, "Time is Up!", Toast.LENGTH_LONG)
                        .show();
                time.setText("Time!");
